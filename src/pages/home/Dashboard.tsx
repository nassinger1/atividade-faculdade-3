        ...
        <div>
            <section className={styles.hero}>
                ...
                <p className={styles.heroText}>
                    Cadastre categorias com a duração em meses e registre
                    matrículas - a data de término do acesso é calculada
                    automaticamente pela regra de negócio da API.
                </p>
            ...
            <section className={styles.stats}>
                ...
                <div className={`${ui.card} ${styles.stat}`}>
                    <span className={`${styles.statNum} ${styles.ok}`}>
                        {active}
                    </span>
