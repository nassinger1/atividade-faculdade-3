...
import { getEnrollment, deleteEnrollment } from "../../api/enrollments";
    ...
    <div>
      ...
      <div className={styles.grid}>
        <div className={`${ui.card} ${styles.cell}`}>
          ...
          {enrollment.category && (
            <span className={styles.sub}>
              ...
              {enrollment.category.durationMonths === 1 ? "mês" : "meses"}
            </span>
          )}
        </div>
        ...
        <div className={`${ui.card} ${styles.cell}`}>
          ...
          <span className={styles.sub}>Calculado pela duração da categoria</span>
        </div>
      </div>
